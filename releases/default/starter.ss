...
3    #_F_report_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Frates); 4=true F for range of ages
#COND 13 17 #_min and max age over which average F will be calculated with F_reporting=4
